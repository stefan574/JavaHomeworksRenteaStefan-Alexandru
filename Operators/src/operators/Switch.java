 ...
 * appropriate method for the requested data types,
 * witch were specified by the user.
 * The doParse class - parses the input witch will
    ...
    static void doSwitch(String string){
        switch(string) {
            ...
            case "19" :
                ...
                break;
            default :
                //Write in log file uncatched input
                break;
        }
    }
